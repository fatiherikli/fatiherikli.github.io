...
flappybird.Bird = Class.extend({
    ...
    init: function (stage) {
        ...
        document.body.addEventListener('mouseup', this.flap.bind(this), { once: true });
    ...
    draw: function () {
        ...
        var angle = 0; //Math.PI - 3;
        this.stage.context.setTransform(1, 0, angle, 1, 0, 0);
